"use strict";
// Type definitions for [~Tastypie Lib~] [~1.0.54~]
// Project: [~ts-resource-tastypie~]
// Definitions by: [~MARCOS WILLIAM FERRETTI~] <[~https://github.com/mw-ferretti~]>
Object.defineProperty(exports, "__esModule", { value: true });
exports.Tastypie = void 0;
...
(function (Tastypie) {
    ...
    var Provider = /** @class */ (function () {
        ...
        Provider.removeAuth = function (providerName) {
            var default_provider = this.getDefault();
            var found = false;
            for (var _i = 0, _a = this._providers; _i < _a.length; _i++) {
                var provider = _a[_i];
    ...
    var Objects = /** @class */ (function () {
        ...
        Objects.prototype.delete = function (id, params) {
            ...
            return axios_1.default({
                ...
                if (_self._resource.model) {
                    var _obj_1 = new _self._resource.model(result.data);
                    if (_self._resource.page.initialized) {
                        return _self._resource.page.refresh().then(function () {
                            _self._resource.working.status = false;
                            return _obj_1;
                        }).catch(function () {
                            _self._resource.working.status = false;
        ...
        Objects.prototype.update = function (id, data) {
            ...
            return axios_1.default({
                ...
                if (_self._resource.model) {
                    var _obj_2 = new _self._resource.model(result.data);
                    if (_self._resource.page.initialized) {
                        return _self._resource.page.refresh().then(function () {
                            _self._resource.working.status = false;
                            return _obj_2;
        ...
        Objects.prototype.create = function (data) {
            ...
            return axios_1.default({
                ...
                if (_self._resource.model) {
                    var _obj_3 = new _self._resource.model(result.data);
                    if (_self._resource.page.initialized) {
                        return _self._resource.page.refresh().then(function () {
                            _self._resource.working.status = false;
                            return _obj_3;
        ...
        Objects.prototype.findOne = function (params, no_slash) {
            var _self = this;
            _self._resource.working.status = true;
            var url = '/' + _self._resource.endpoint;
            if (no_slash) {
                url = url.slice(0, -1);
            }
            return axios_1.default({
    ...
    var Model = /** @class */ (function () {
        ...
        Model.prototype.save = function (obj) {
            var _self = this;
            var to_save = obj ? Tools.merge_obj(_self.getData(), obj) : _self.getData();
        ...
        Model.prototype.setLocalFile = function (field, event) {
        ...
        Model.prototype.changeFileBase64 = function (field, fileBase64) {
            var _self = this;
            if (!_self.id)
                return Tools.generate_exception('[Tastypie][Model][updateFile] This object has not been saved.');
            var obj_param = {};
